...
#plot the charts in a 2x2 format

par(mfrow = c(2, 2)) 

plot(combdatetime, as.numeric(powerset$Global_active_power), type = "l", xlab = "", ylab = "Global Active Power")

plot(combdatetime, as.numeric(powerset$Voltage), type = "l", xlab = "datetime", ylab = "Voltage")

plot(combdatetime, as.numeric(powerset$Sub_metering_1), type = "l", xlab = "", ylab = "Energy sub metering")
...
plot(combdatetime, as.numeric(powerset$Global_reactive_power), type = "l", xlab = "datetime", ylab = "Global_reactive_power")
